...
@section('content')
    ...
    <div class="row">
        <form class="col s12" enctype="multipart/form-data" action="/admin/add-video" method="post">
            ...
            <div class="row">
                <div class="input-field col s6">
                    <input id="path" type="text" class="validate" name="path">
            ...
            <div class="row">
                <div class="input-field col s12">
                    ...
                    <input type="submit" class="waves-effect waves-light btn" value="Add New Videos">
                </div>
            </div>
        </form>
    </div>
